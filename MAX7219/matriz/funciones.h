...
void displayMatrizAnalog(LedControl lc, int tim, int A0);
void linalDisplay(LedControl lc, int t);

//*****************         Funciones      ********************************

//Descripcion:  luz se desplaza de un lado al otro
//Paraqmetros:  LedControl (lc), delay (100ms)
//Firma:        linalDisplay(lc,20);
...
//***********************************************************************
//Descripcion:  muestra datos analogicos (0-99) por desplazamiento
//Paraqmetros:  LedControl (lc), delay (100ms), int analogico (A0)
//Firma:        displayMatrizAnalog(lc,100,0);

void displayMatrizAnalog(LedControl lc, int tim, int A0){
  lc.clearDisplay(0);
  displayMatriz(map(analogRead(A0),0,1023,0,99),lc,tim);
  delay(200);
}
//***********************************************************************
